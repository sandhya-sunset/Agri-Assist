...
const recommendations = [
  {
    ...
    plantType: "Apple",
    description:
      "Fungal disease caused by Venturia inaequalis affecting leaves and fruits",
    symptoms: [
  ...
  },
  {
    ...
    plantType: "Apple",
    description:
      "Fungal disease caused by Botryosphaeria obtusa affecting fruit and leaves",
    symptoms: [
  ...
  },
  {
    ...
    plantType: "Apple",
    description:
      "Fungal disease requiring both apple and cedar trees to complete lifecycle",
    symptoms: [
      "Orange spots on upper leaf surface",
      "Yellow lesions on fruit",
    ...
    fertilizers: [
      {
        ...
        description:
          "Maintains soil health and provides slow-release nutrients",
  ...
  },
  {
    ...
    plantType: "Grape",
    description:
      "Fungal disease affecting grapes, caused by Guignardia bidwellii",
    symptoms: [
  ...
  },
  {
    ...
    symptoms: [
      "Small dark spots on leaves",
      "Fruit lesions with white halos",
      "Leaf yellowing",
    ],
    fertilizers: [
      {
