...
const OrdersSection = ({ searchQuery }) => {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-500 py-2">
              Use the top bar to search orders.
            </p>
          </div>
      ...
      {selectedOrder && (
        <div
          className="fixed inset-0 flex items-center justify-center z-50 p-4 overflow-y-auto w-full h-full"
          ...
          <div className="bg-white rounded-xl max-w-3xl w-full my-8 relative">
            ...
            <div className="p-6 space-y-6 max-h-[calc(100vh-200px)] overflow-y-auto">
              ...
              <div className="flex items-center justify-between">
                <span
                  className={`inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-semibold border ${getStatusColor(selectedOrder.status)}`}
                >
