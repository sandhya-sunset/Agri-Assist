    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">
          Configure commission rates for different product categories
        </p>
      </div>
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    value={rate}
                    onChange={(e) =>
                      updateCommissionRate(category, e.target.value)
                    }
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-linear-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200">
              ...
              <p className="text-2xl font-bold text-blue-900">
                ₹{(stats.commissionEarned * 0.3).toFixed(0).toLocaleString()}
              </p>
            ...
            <div className="p-4 bg-linear-to-br from-purple-50 to-purple-100 rounded-xl border border-purple-200">
              ...
              <p className="text-2xl font-bold text-purple-900">
                {(
                  Object.values(commissionSettings).reduce((a, b) => a + b, 0) /
                  Object.values(commissionSettings).length
                ).toFixed(1)}
                %
              </p>
