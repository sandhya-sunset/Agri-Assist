                ...
                <>
                  ...
                  <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-linear-to-b from-gray-50 to-white flex flex-col-reverse">
                    ...
                    {selectedConversation.messages.map((msg) => (
                      ...
                      >
                        <div
                          className={`max-w-md ${msg.sender === "user" ? "order-2" : "order-1"}`}
                        >
                          <div
                          ...
                          <div
                            className={`flex items-center gap-2 mt-1 px-2 ${msg.sender === "user" ? "justify-end" : "justify-start"}`}
                          >
                  ...
                  <div className="p-4 border-t border-gray-200 bg-white">
                    ...
                    <p className="text-xs text-gray-400 mt-2 ml-2">
                      ...
                      send, <span className="font-semibold">Shift + Enter</span>{" "}
                      for new line
                    </p>
                  </div>
                </>
          ...
          {[
            ...
            >
              <div className="flex items-center justify-between mb-2">
                ...
                <span
                  className={`text-xs font-semibold text-${stat.color}-600 bg-${stat.color}-50 px-2 py-1 rounded-full`}
                >
                  Active
                </span>
              </div>
