  ...
  const renderContent = () => {
    switch (activeTab) {
      case "products":
        return (
          <ProductsSection
            initialShowAddModal={showAddProductModal}
...
const OverviewSection = ({ sellerData, onAddProduct }) => {
  const stats = [
    ...
    {
      label: "Total Orders",
      value: sellerData.orders,
      change: "+8.2%",
      color: "blue",
    },
    {
      label: "Products",
      value: sellerData.products,
      change: "+3",
      color: "purple",
    },
    {
      label: "Pending Messages",
      value: sellerData.messages,
      change: "2 new",
      color: "orange",
    },
  ];
    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
          ...
          <div className="space-y-4">
            {["Organic NPK Mix", "Plant Growth Booster", "Root Enhancer"].map(
              (product, idx) => (
                <div
                  key={idx}
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 font-medium">
                        {45 - idx * 5} sales this month
                      </p>
                    </div>
                  </div>
                  <span className="text-gray-900 font-bold">
                    Rs {(299.0 - idx * 20).toFixed(2)}
                  </span>
                </div>
              ),
            )}
