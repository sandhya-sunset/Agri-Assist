  ...
  const aiFeatures = [
    {
      ...
      description:
        "AI-powered image analysis to identify plant diseases instantly",
      color: "blue",
    },
    {
      icon: Sparkles,
      ...
      description:
        "Get personalized fertilizer suggestions based on your crops",
      color: "purple",
    },
    {
      icon: TrendingUp,
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <p className="text-lg md:text-xl text-gray-600 leading-relaxed">
                Premium fertilizers backed by AI technology. Detect diseases,
                get personalized recommendations, and achieve healthier crops
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Leverage cutting-edge AI technology to optimize your farming
              practices and maximize yields
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg text-green-100 mb-8">
              Join thousands of farmers using AI-powered solutions to grow
