        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-500 mt-1 ml-14">
              You have{" "}
              <span className="font-bold text-green-600">{unreadCount}</span>{" "}
          ...
          {notifications.length > 0 ? (
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-1">
                      <h3
                        className={`font-bold text-gray-900 truncate pr-4 ${!notification.isRead ? "text-black" : "text-gray-600"}`}
                      >
                        {notification.title}
                      </h3>
            ...
            <div className="text-center py-20 bg-white rounded-3xl border border-gray-100 shadow-sm border-dashed">
              ...
              <p className="text-gray-500 max-w-sm mx-auto">
                We'll notify you when you receive messages, orders, or updates
                about your products.
              </p>
            </div>
          )}
